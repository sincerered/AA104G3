...
<FORM method="post" id="submitForm" action="<%= request.getContextPath() %>/reservation/reservation.do">
	...
	<input type="hidden" name="resvno" value="">
	<input type="hidden" name="whichPage" value="${requestScope.whichPage }">
	<input type="hidden" name="requestURL" value="<%= request.getServletPath()%>">
	<input type="hidden" id="compositeQuery" name="compositeQuery" value="">
...
<div id="compositeQueryPanel">
	<input type="text" data-key="resvno" placeholder="resvno" value="${param.resvno}">
	<input type="text" data-key="memname" placeholder="memname" value="${param.memname}">
	<input type="text" data-key="memno" placeholder="memno" value="${param.memno }">
	<input type="text" data-key="memid" placeholder="memid" value="${param.memid }">
	<input type="text" data-key="stono" placeholder="stono" value="${param.stono }">
