		...
		<div class="row">
			...
			<div class="col-xs-12 col-sm-10">
				<ol class="breadcrumb">
					...
					<li><a href="<%=request.getContextPath()%>/store/store.do?action=get_store_detail">會員資料</a></li>
				...
				<div class="col-xs-12 col-sm-12">
			        ...
			        <form class="chenken-input-text" action="<%= request.getContextPath() %>/store/store.do">
			          <input type="password" name="stopwOld" placeholder="舊密碼">
			          <br>
			          <br>
			          <input type="password" name="stopwNew" placeholder="新密碼">
			          <input type="password" name="stopwConfirm" placeholder="密碼確認">
